...
export interface Issue {
  id: string;
  type: 'pothole' | 'garbage' | 'water_leak' | 'broken_light' | 'road_damage' | 'flooding' | 'hazard' | 'manhole';
  lat: number;
  lng: number;
  status: 'reported' | 'verified' | 'resolving' | 'resolved';
  ...
  image?: string;
  description?: string;
  predicted?: boolean; // If generated by AI
}

export type AppMode = 'explore' | 'search' | 'place' | 'directions' | 'active_nav' | 'report' | 'issue' | 'profile';
